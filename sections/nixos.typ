...
#grid(
  ...
  [
    #text(
      size: 14pt,
      raw(read("../examples/example-module/options.nix"), lang: "Nix"),
    )
  ],
  [
    #pause
    #text(
      size: 14pt,
      raw(read("../examples/example-module/config.nix"), lang: "Nix"),
    )
  ],
  [
    #pause
    #text(
      size: 14pt,
      raw(read("../examples/example-module/default.nix"), lang: "Nix"),
    )
  ],
)
